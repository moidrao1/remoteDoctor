...
<body>
    <section class="bg">
        <div class="inner">
            ...
            <div class="container center-align" id="userDiv">
            ...
            <div class="row hidden" id="displayDivs">
            ...
            <div class="container row center-align">
                ...
                <div class="col s3">
                    <a href="#videocam" id="videocam"  class="btn btn-floating btn-medium orange" onclick="javascript:showVideo('videocam');"><i class="material-icons">videocam</i></a>
                    
                    <a href="#videocam_off" id="videocamOff" style="display: none;" class="btn btn-floating btn-medium orange" onclick="javascript:hideVideo('videocamOff');"><i class="material-icons">videocam_off</i></a>
                </div>
                <div class="col s3">
